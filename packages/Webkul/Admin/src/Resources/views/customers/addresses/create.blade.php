...
@section('content')
    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('admin.customer.addresses.store', ['id' => $customer->id]) }}"
            @submit.prevent="onSubmit">
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link"
                            onclick="window.location = '{{ route('admin.customer.addresses.index', ['id' => $customer->id]) }}'"></i>
                ...
                <div class="form-container">
                    ...
                    <accordian :title="'{{ __('admin::app.customers.addresses.general') }}'" :active="true">
                        <div slot="body">
                            ...
                            @include ('admin::customers.country-state', ['countryCode' => old('country') ??
                            config('app.default_country'), 'stateCode' => old('state') ?? ''])
                            ...
                            <div class="control-group" :class="[errors.has('postcode') ? 'has-error' : '']">
                                ...
                                <span class="control-error"
                                    v-if="errors.has('postcode')">@{{ errors . first('postcode') }}</span>
                            </div>
                            ...
                            <div class="control-group">
                                <span class="checkbox">
                                    <input type="checkbox" class="control" id="default_address" name="default_address"
